  ...
  M.Modal.init(modalElems, {
      onOpenEnd: function() {
          ...
          $('.slider-tp2b').slick({
              ...
              arrows: false,
              fade: true,
              asNavFor: '.slider-tp2b-nav',
          });
          $('.slider-tp2b-nav').slick({
            infinite: false,
            slidesToShow: 3,
            slidesToScroll: 1,
            asNavFor: '.slider-tp2b',
            dots: false,
            centerMode: false,
            focusOnSelect: true
        });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  tp2bPosts.forEach(function (post) {
    post.addEventListener("click", function () {
      ...
      var thumbnailsmall = post.getAttribute("data-small-thumbnail");
      ...
      var hotelData = JSON.parse(post.getAttribute('data-hotel'));
      ...
      hotelData.forEach(function(hotelItem) {
        var hotelTitle = hotelItem.hotel_select_tp2b.post_title;
        var hotelCategories = hotelItem.hotel_select_tp2b.category; // Ajusta el nombre según la estructura real
        var hotelLink = hotelItem.hotel_select_tp2b.link;
      ...
      var modalContent = `
              <div class="row">
                  <div class="col s6">
                    ...
                    <div class="slider-tp2b-nav">
                      <img src="${thumbnailsmall}" alt="${title}" class="responsive-img">
                      ${galleryHtml} 
                    </div>
                  </div>
                  <div class="col s6">
                      <div class="row">
                        ...
                        <div class="col s10"><h4>${title}</h4></div>
                      </div>
                      <p>${descripcion}</p>
                      ${hotelDataHtml}
                      <hr>
